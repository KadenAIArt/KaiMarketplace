<template>
  <section style="background-image: linear-gradient(to right bottom, #a9347e, #4b32a7) !important; height: 100vh; width:100vw; overflow: hidden !important;">
    <div class="stars">
      <div class="star"></div>
      <div class="star"></div>
      <div class="star"></div>
      ...
      <div class="circle circle--inner">
        ...
        <div class="circle oh">
          ...
          <div class="circle planet">
            <img style="left: 0px; position: relative; top: 0px;" width="200" src="/images/kadenai_black.svg">
        ...
        <a href="/" class="button">BACK TO KADENAI</a>
      </div>
      <div style="width: 200px; left: 40px; top: 210px;" class="center">Page not found.</div>
      <div style="width: 200px; left: 44px; top: 180px;" class="center">Lost in space..</div>
      <div style="width: 200px; left: 20px; top: 240px;" class="center">You reached the edge.</div>
    </div>
  </section>
...
body, html {
  ...
  background-image: linear-gradient(to right bottom, #a9347e, #4b32a7) !important;
...
@-webkit-keyframes floating {
  ...
  60% {
    -webkit-transform: translate(0px, -3px) rotate(2deg);
